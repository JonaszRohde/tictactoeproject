...
public class GameLogic
{
    ...
    public boolean winnerCheck()
    {
        ...
        // Liczenie zapelnionych pol gdy zadne z powyzszych ifow nie zadziala
        int boardFilled = 0;
    ...
    public void resetGame()
    {
        ...
        playerTurn.setTextColor(Color.parseColor("#F44336"));
    }
    ...
    public boolean updateGameBoard(int row, int col)
    {
        if (gameBoard[row-1][col-1] == 0)
        {
            ...
            if (player ==1)
            {
                ...
                playerTurn.setTextColor(Color.parseColor("#00B0FF"));
            }
            else
            {
                playerTurn.setText((playerNames[0] + "'s Turn"));
